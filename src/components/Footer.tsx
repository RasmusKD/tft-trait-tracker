...
export default function Footer() {
    ...
    return (
        <footer
            className="flex flex-col gap-1 items-center justify-center p-4 bg-zinc-900/75 border-t border-zinc-800 text-sm text-zinc-400 font-mono">
            <div className="flex flex-wrap items-center justify-center gap-2 text-center relative">
                Made with <span className="text-red-500">❤</span> by
                <a
                    href="https://github.com/RasmusKD"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-white flex items-center gap-1"
                >
                    <FaGithub className="size-4"/> RasmusKD
                </a>
                ·
                <button
                    onClick={copyDiscord}
                ...
                <a
                    href="mailto:contact@traittracker.gg"
