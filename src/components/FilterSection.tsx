...
import { getSetConfig } from "@/utils/championMapping"; // Removed getSetNumber as setFolder is better
            ...
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="hidden md:block text-zinc-400 text-sm">
                        Add your emblems to see comps that use the fewest units and lowest
                        cost.
                    </p>
                </div>
