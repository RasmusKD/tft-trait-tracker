...
export default function Home() {
    ...
    if (!isPageReady) { // Show loader until all states for the current set are initialized
    ...
    return (
        <div className="min-h-screen flex flex-col bg-fixed bg-cover bg-center overflow-x-hidden overflow-y-auto bg-[url(/bg.png)]">
            ...
            />
            {/* ... rest of the JSX remains largely the same, ensuring currentSetIdentifier is passed down ... */}
                        ...
                        <div className="bg-zinc-900/75 border border-zinc-800 shadow-lg rounded p-4 min-w-0 mb-4 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className="flex items-center gap-2 hover:bg-zinc-800 text-white px-3 py-1 rounded-lg transition"
                                >
